...
import { BreakEvenRoasSimulationDetailPage } from "@/modules/pricing/components/break-even-roas-simulation-detail-page";

export default async function BreakEvenRoasSimulationDetailRoute({
  params,
}: {
  ...
  return <BreakEvenRoasSimulationDetailPage simulationId={id} />;
}
