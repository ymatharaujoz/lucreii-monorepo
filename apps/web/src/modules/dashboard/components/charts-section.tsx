...
import { formatMetricDate, formatMoneyCompact } from "../utils/formatters";
              ...
              >
                <defs>
                  ...
                  >
                    <stop
                      offset="5%"
                      stopColor={chartColors.grossRevenue}
                      stopOpacity={0.15}
                    />
                    <stop
                      offset="95%"
                  ...
                  >
                    <stop
                      offset="5%"
                      stopColor={chartColors.netProfit}
                      stopOpacity={0.15}
                    />
                    <stop
                      offset="95%"
